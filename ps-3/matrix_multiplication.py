...
plt.title("Matrix multiplication by loop, log(t) to log(N)")
plt.savefig("matmult-loop-log.png")
...
plt.xlabel("log(N)")
plt.ylabel("log(t) (log(s))")
plt.title("Matrix multiplication by np.dot, log(t) to log(N)")
plt.savefig("matmult-np-log.png")
